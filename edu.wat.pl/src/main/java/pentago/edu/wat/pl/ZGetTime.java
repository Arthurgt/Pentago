...
public class ZGetTime extends SwingWorker<Integer, String> {
	private String date;
	private String time;

	public ZGetTime(String d,String t) 
	{
		this.date=d;
		this.time=t;
	}

	public ZPolandTime getjson() 
	{
		...
		try 
		{
			...
			ZPolandTime pt = (ZPolandTime) objectmapper.readValue(responseString, ZPolandTime.class);
			return pt;
		} 
